...
inline extern_var(0x685454, gfxTexture*, font_texture);

inline extern_var(0x685458, int, font_width);
inline extern_var(0x68545C, int, font_height);

inline extern_var(0x5CD530, gfxFontInfo, SYSFONT);
