...
/*
    ...
    0x4C5BB0 | public: static void __cdecl datArgParser::Init(void) | ?Init@datArgParser@@SAXXZ
    0x4C5BC0 | public: static void __cdecl datArgParser::Init(int,char * *) | ?Init@datArgParser@@SAXHPAPAD@Z
