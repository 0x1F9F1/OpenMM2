...
inline_var(0x6A3C64, char[128], MapFileTimestamp);
inline_var(0x6A3CE4, MapSymbol*, MapFileAddresses);
inline_var(0x6A3CE8, int, MapFileAddressCount);
inline_var(0x6A3CEC, bool, IsMapInitialized);
