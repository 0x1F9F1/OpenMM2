...
/*
    ...
    struct IDirect3DDevice7 * lpD3DDevSoftware | ?lpD3DDevSoftware@@3PAUIDirect3DDevice7@@A
...
inline extern_var(0x6830DC, i32, interfaceCount);
...
inline extern_var(0x6830D8, i32, useInterface);
