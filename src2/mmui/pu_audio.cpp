...
{
    return stub<thiscall_t<void, PUAudioOptions*>>(0x50C990, this);
}

void PUAudioOptions::PreSetup()
{
    return stub<thiscall_t<void, PUAudioOptions*>>(0x50C980, this);
}

void PUAudioOptions::SetBalance()
{
    return stub<thiscall_t<void, PUAudioOptions*>>(0x50C940, this);
}

void PUAudioOptions::SetCDVolume()
{
    return stub<thiscall_t<void, PUAudioOptions*>>(0x50C910, this);
}

void PUAudioOptions::SetWaveVolume()
{
    return stub<thiscall_t<void, PUAudioOptions*>>(0x50C8F0, this);
}
