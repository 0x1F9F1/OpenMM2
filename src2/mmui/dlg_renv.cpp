...
{
    return stub<thiscall_t<void, Dialog_RaceEnvironment*>>(0x4FBA30, this);
}

void Dialog_RaceEnvironment::ControlPedSlider()
{
    return stub<thiscall_t<void, Dialog_RaceEnvironment*>>(0x4FB980, this);
}

void Dialog_RaceEnvironment::DoneCallback()
{
    return stub<thiscall_t<void, Dialog_RaceEnvironment*>>(0x4FB9E0, this);
}

void Dialog_RaceEnvironment::PreSetup()
{
    return stub<thiscall_t<void, Dialog_RaceEnvironment*>>(0x4FB930, this);
}

void Dialog_RaceEnvironment::SetMultiRaceOptions(i32 arg1)
{
    return stub<thiscall_t<void, Dialog_RaceEnvironment*, i32>>(0x4FB9A0, this, arg1);
}
