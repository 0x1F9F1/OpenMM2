...
{
    return stub<thiscall_t<void, Dialog_HallOfFame*>>(0x4FC6A0, this);
}

void Dialog_HallOfFame::PreSetup()
{
    return stub<thiscall_t<void, Dialog_HallOfFame*>>(0x4FC030, this);
}

void Dialog_HallOfFame::ResetRaceRecord()
{
    return stub<thiscall_t<void, Dialog_HallOfFame*>>(0x4FC570, this);
}

void Dialog_HallOfFame::SetSortState()
{
    return stub<thiscall_t<void, Dialog_HallOfFame*>>(0x4FC620, this);
}

void Dialog_HallOfFame::SortByCity()
{
    return stub<thiscall_t<void, Dialog_HallOfFame*>>(0x4FC600, this);
}
