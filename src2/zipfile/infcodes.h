...
{
    return stub<cdecl_t<struct inflate_codes_state*, uint32_t, uint32_t, struct inflate_huft_s*, struct inflate_huft_s*,
        struct z_stream_s*>>(0x5753D0, arg1, arg2, arg3, arg4, arg5);
}

// 0x575410 | ?inflate_codes@@YAHPAUinflate_blocks_state@@PAUz_stream_s@@H@Z
inline int32_t inflate_codes(struct inflate_blocks_state* arg1, struct z_stream_s* arg2, int32_t arg3)
{
    return stub<cdecl_t<int32_t, struct inflate_blocks_state*, struct z_stream_s*, int32_t>>(
        0x575410, arg1, arg2, arg3);
}
