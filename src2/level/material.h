...
{
    // const lvlMaterialMgr::`vftable' @ 0x5B1B04
...
check_size(lvlMaterialMgr, 0x1C);

class lvlMaterial : public phMaterial
{
    // const lvlMaterial::`vftable' @ 0x5B1AF8
